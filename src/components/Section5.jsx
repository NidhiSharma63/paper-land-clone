...
const Section5 = React.forwardRef((_, ref) => {
  ...
  return (
    <div className="section-5 max-w-[1920px] m-auto h-auto flex  bg-[#fccff6] text-[#373637] align-middle justify-between md:p-[4rem] pt-[4rem] p-[1rem] pl-[1rem] md:pl-[7rem] flex-col gap-16">
      ...
      <div className="image-grid grid md:grid-cols-4 grid-cols-2 gap-8">
        {data.map((elem) => {
          return (
            <div
            ...
            >
              <div className="w-full rounded-xl overflow-hidden">
                <img
                  className="w-full h-full transition-transform duration-300 ease-out group-hover:scale-110  section-5-card-image object-cover"
                  src={elem.image}
                  alt={elem.heading1}
              ...
              <div className="flex flex-col align-middle text-center">
                <p className="md:text-[22px] text-[15px] 2xl:text-[26px] 3xl:text-[30px] font-bold transition-transform duration-300 ease-out group-hover:scale-125">
                  {elem.heading1}
                </p>
                <p className="md:text-[20px] text-[15px]">Skipton Art Place</p>
                <p className="md:text-[20px] text-[15px] 2xl:text-[26px] 3xl:text-[30px]  md:mt-2 mt-1">
                  £24.00 – £42.00
                </p>
              </div>
            </div>
